// The Codeberg mark (the mountain logo). Inline SVG so it inherits `color`
// via currentColor and ships no extra request. Path from Simple Icons (CC0).
export default function CodebergLogo(props: { class?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      class={props.class}
